"""FlowNet2 (E. Ilg et al., CVPR 2017), vendored for optical-flow estimation.

Upstream: https://github.com/NVIDIA/flownet2-pytorch (via LiUzHiAn/hf2vad,
MIT); the correlated/resample2d/channelnorm layers are the upstream custom
CUDA extensions and must be built before use (see install_custom_layers.sh).
"""
...
class FlowNet2(nn.Module):
    ...
    def forward(self, inputs):
        # inputs: [bs, 3, 2, H, W] with values in [0, 255]
